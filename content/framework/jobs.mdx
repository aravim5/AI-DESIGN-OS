...
|---|---|
| **Ask** | Get a direct answer to a specific question |
| **Find** | Locate records, documents, or entities |
| **Understand** | Build comprehension of a situation, entity, or trend |
| **Decide** | Choose between options or determine a course of action |
| **Create** | Produce a new artifact — document, message, plan |
| **Execute** | Complete a workflow step or trigger an action |
| **Monitor** | Track changes, risks, or status over time |
| **Remember** | Retain and recall commitments, preferences, or prior context |
| **Collaborate** | Coordinate with other people or systems |
| **Recover** | Fix an error, resolve ambiguity, or resume interrupted work |
